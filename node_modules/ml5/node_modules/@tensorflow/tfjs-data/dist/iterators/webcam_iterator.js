...
var WebcamIterator = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    case 0:
                        if (this.webcamConfig.facingMode) {
                            util_1.assert((this.webcamConfig.facingMode === 'user') ||
    ...
    WebcamIterator.prototype.cropAndResizeFrame = function (img) {
        ...
        var resizedImage;
        resizedImage = tfjs_core_1.image.cropAndResize(expandedImage, this.cropBox, this.cropBoxInd, this.cropSize, 'bilinear');
