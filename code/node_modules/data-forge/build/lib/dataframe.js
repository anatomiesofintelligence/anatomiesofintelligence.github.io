...
var DataFrame = /** @class */ (function () {
    ...
    */
    ...
    DataFrame.prototype.serialize = function () {
        ...
        if (indexType === "date") {
            indexValues = indexValues.map(function (index) { return moment(index).toISOString(true); }); // Manually serialize date value, they aren't supported directly by JSON.
        }
        var cloned = false;
        try {
    ...
    DataFrame.deserialize = function (input) {
        ...
        if (input.index && input.index.type === "date") {
            indexValues = indexValues.map(function (value) { return moment(value, moment.ISO_8601).toDate(); }); // Manually deserialize data value.
        }
        return new DataFrame({
